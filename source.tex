...
In this section, we only characterize the path loss resulting from the Gaussian antenna gain patterns of the satellite BSs. It is given over the planar distance $r \in [0, \infty)$ as
  \begin{equation}
