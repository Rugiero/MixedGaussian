...
\begin{prop}
  The density of the $k$th factorial moment measure \cite[Corollary 10]{7305791} of the STIR process at the typical LEO BS with a narrow Gaussian antenna beam and Gaussian mixture shadow fading is (approximately) given by
  \begin{align}
