...
Considering an adaptive encoding and decoding that adapts according to the SIR of the served UE (after the SIC) at the typical LEO BS, the expected total bandwidth-normalized Shannon throughput \cite[Eq. (7.19)]{alma998193414406526} of the $n$ served UEs under the SIC is
\begin{align}
  ...
  &=\sum_{k=1}^n\int_{\tau}^{\infty}\frac{\mathcal{P}^{(k)}_{\textup{SIC}}(t)}{(t+1)\log(2)}d t. \label{eq:throughput}
\end{align}
