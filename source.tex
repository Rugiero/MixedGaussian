...
\begin{prop}
  The density of the $n$th factorial moment measure of the STIR process at the typical LEO BS with a narrow Gaussian antenna beam and Gaussian mixture shadow fading is approximately given by
  \begin{align}
