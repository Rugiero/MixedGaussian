...
axis([[0,max],[0,10]])
legend('Log-normal mixture shadowing','Defective exponential shadowing',...
    'Interpreter','latex',...
    'FontSize',14)
fontsize(14,"points")
...
%%     'String','$\kappa \upsilon \in \{$',...
%%     'Position',[0.00691244239631361 0.214714714714713 0]);

%% % Create text
%% text('Parent',axes1,'FontSize',14,'Interpreter','latex','String','$1.8$',...
%%     'Position',[0.15 0.199699699699698 0],...
%%     'Color',[0.6350 0.0780 0.1840]);


%% % Create text
%% text('Parent',axes1,'FontSize',14,'Interpreter','latex','String','$2.6$',...
