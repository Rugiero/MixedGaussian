...
plot(tKAPPA*log(2),dist1,'color',"black",'linewidth',2)
plot(tKAPPA*log(2),dist2,'color',"black",'linewidth',2)
plot(tKAPPA*log(2),dist3,'color',"#D95319",'linewidth',2)
