...
title('$\tilde{\kappa}\rho_{\epsilon}=3$')


% Create textarrow
annotation(figure1,'textarrow',[0.300000000000001 0.343859649122807],...
    [0.651111111111111 0.633333333333333],'String',{'$\epsilon=90^{\circ}$'},'FontSize',14,'Interpreter','latex');

% Create textbox
annotation(figure1,'textbox',...
    [0.40 0.545666665818956 0.0692982466531262 0.064444445292155],...
    'String',{'$90^{\circ}$'},...
    'LineStyle','none','FontSize',14,'Interpreter','latex');

% Create textbox
annotation(figure1,'textbox',...
    [0.329824561403509 0.592333332485623 0.0692982466531262 0.064444445292155],...
    'String',{'$40^{\circ}$'},...
    'LineStyle','none','FontSize',14,'Interpreter','latex');

% Create textarrow
annotation(figure1,'textarrow',[0.556140350877193 0.46140350877193],...
    [0.642222222222222 0.584444444444444],'String',{'$\epsilon=40^{\circ}$'},'FontSize',14,'Interpreter','latex');
